    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex justify-between items-center h-16">
        ...
        >
          ...
          <div>
            <h1 class="text-xl font-bold tracking-wide text-white">中泰词典</h1>
            <p class="text-xs text-yellow-200 -mt-1">Chinese-Thai Dictionary</p>
          </div>
        </router-link>
        ...
        >
          <svg class="w-6 h-6 stroke-white hover:stroke-yellow-200" fill="none" viewBox="0 0 24 24">
      ...
      <div 
        ...
        class="md:hidden bg-red-700 rounded-lg mt-2 shadow-lg border-t border-red-500"
      >
        <div class="px-4 py-3 space-y-3">
          ...
          <router-link 
            ...
            class="block px-3 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center"
          ...
          <div v-if="isAuthenticated" class="border-t border-red-500 pt-3">
            <button 
              @click="logout"
              class="block px-3 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center w-full text-white hover:text-yellow-200 hover:bg-red-800"
            >
              <svg class="w-4 h-4 mr-3 fill-current" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clip-rule="evenodd"/>
              </svg>
          ...
          <div v-else class="space-y-3 border-t border-red-500 pt-3">
            <router-link 
              to="/login" 
              @click="closeMobileMenu"
              class="block px-3 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center"
            ...
            <router-link 
              to="/register" 
              @click="closeMobileMenu"
              class="block bg-yellow-400 hover:bg-yellow-500 text-red-800 font-medium px-4 py-2 rounded-lg transition-colors duration-200 text-center"
            >
              สมัครสมาชิก
            </router-link>
          </div>
